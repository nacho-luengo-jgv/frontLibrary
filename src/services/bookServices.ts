...
export const url_api_usuario= 'http://localhost:8080/usuarios'
export const url_api_admin= 'http://localhost:8080/admin'
...
export const solicitarPrestamo = (idUsuario: number, idLibro: number) =>
  axios.post(`${url_api_usuario}/${idUsuario}/prestamos/${idLibro}`, {} ,{
    auth: credencialesUser
  })

export const devolverPrestamo = (idUsuario: number, idLibro: number) =>
  axios.post(`${url_api_usuario}/${idUsuario}/devoluciones/${idLibro}`, {} ,{
    auth: credencialesUser
  })
